...
class TableDatasetTest(parameterized.TestCase, tf.test.TestCase):
    ...
    @parameterized.named_parameters(
        ...
        (
            ...
            10,
            10,
            table_dataset.TableTask.PRETRAINING,
            False,
            False,
            False,
            False,
    ...
    def test_parse_table_examples(
        ...
        if add_candidate_answers:
            ...
            self.assertAllEqual(
                features_vals["can_label_ids"].shape,

...
flags.DEFINE_string("interaction_dir", None, "Directory with interaction tfrecords.")
...
flags.DEFINE_string(
    "output_dir", None, "Directory where new interactions are written to."
)
...
def _get_inputs_outputs(
    ...
    interaction_paths = tf.io.gfile.glob(os.path.join(interaction_dir, "*.tfrecord"))

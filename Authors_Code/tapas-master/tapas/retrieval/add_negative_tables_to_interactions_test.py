...
def _get_interaction(interaction_id, question_id, table):
        ...
        questions=[
            interaction_pb2.Question(
                ...
                answer=interaction_pb2.Answer(
                    answer_coordinates=[
                        interaction_pb2.AnswerCoordinate(row_index=0, column_index=0),
                    ],
...
class AddNegativeTablesToInteractionsTest(parameterized.TestCase):
    ...
    def _verify_negative_table(
        self, output, interaction_id, expected_table_id, expected_rank, expected_score
    ):
    ...
    def test_flume_add_negative_tables(
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            pipeline = (
                add_negative_tables_to_interactions.add_negative_tables_to_interactions(

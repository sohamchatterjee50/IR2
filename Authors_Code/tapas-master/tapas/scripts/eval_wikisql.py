...
flags.DEFINE_list("prediction_files", None, 'Produced by "convert_predictions".')
...
def main(argv):
    ...
    for reference_file, prediction_file in zip(
        FLAGS.reference_files, FLAGS.prediction_files
    ):

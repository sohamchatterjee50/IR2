...
flags.DEFINE_string("model_dir", None, "The directory where the model will be stored.")
...
# Training parameters.
flags.DEFINE_integer(
    "num_train_examples", None, "Number of examples seen during training."
)
...
flags.DEFINE_float(
    "bert_config_initializer_range", None, "Override for BertConfig.initializer_range"
)
flags.DEFINE_float(
    "bert_config_softmax_temperature",
    None,
...
flags.DEFINE_integer("tpu_iterations_per_loop", 1000, "TPU batch iterations per loop.")
flags.DEFINE_integer(
    "num_tpu_cores",
    None,
...
def save_metrics(
    ...
    calc_metrics_utils.write_to_tensorboard(
        metrics, step, os.path.join(model_dir, mode)
    )

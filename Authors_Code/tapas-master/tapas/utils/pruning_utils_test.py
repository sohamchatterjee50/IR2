...
class PruningUtilsTest(parameterized.TestCase):
    ...
    def _assert_equals_selected_columns(self, expected_set, selected_tokens_set):
        selected_columns = set([coord.column_index for coord in selected_tokens_set])
    ...
    def test_SelectAllTokensFn(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            selected_columns = selector.select_tokens(
                interaction, interaction.questions[0]
            )
    ...
    def test_SelectHeuristicExactMatchCellsFn(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            interaction = self._get_interaction()
            selected_cells = selector.select_tokens(
                interaction, interaction.questions[0]
            )
      ...
      """
        self.assertEqual(
            ...
            text_format.Parse(
                expected_debug, table_selection_pb2.TableSelection.DebugInfo()
            ),
        )
    ...
    def test_MaxTokenSelector(
        ...
        self._assert_equals_selected_columns(
            expected_columns, selected_columns.selected_tokens
        )

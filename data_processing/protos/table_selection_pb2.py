...
from data_processing.protos import (
    interaction_pb2 as tapas_dot_protos_dot_interaction__pb2,
)
...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "tapas.protos.table_selection_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    tapas_dot_protos_dot_interaction__pb2.Question.RegisterExtension(
        _TABLESELECTION.extensions_by_name["table_selection_ext"]
    )

    DESCRIPTOR._options = None
    _TABLESELECTION._serialized_start = 87
    _TABLESELECTION._serialized_end = 1080
    _TABLESELECTION_TOKENCOORDINATES._serialized_start = 321
    _TABLESELECTION_TOKENCOORDINATES._serialized_end = 401
    _TABLESELECTION_MODELPREDICTIONSTATSPERMODEL._serialized_start = 403
    _TABLESELECTION_MODELPREDICTIONSTATSPERMODEL._serialized_end = 471
    _TABLESELECTION_MODELPREDICTIONSTATSPERCOLUMN._serialized_start = 474
    _TABLESELECTION_MODELPREDICTIONSTATSPERCOLUMN._serialized_end = 614
    _TABLESELECTION_MODELPREDICTIONSTATS._serialized_start = 617
    _TABLESELECTION_MODELPREDICTIONSTATS._serialized_end = 827
    _TABLESELECTION_DEBUGINFO._serialized_start = 830
    _TABLESELECTION_DEBUGINFO._serialized_end = 989
    _TABLESELECTION_DEBUGINFO_COLUMN._serialized_start = 909
    _TABLESELECTION_DEBUGINFO_COLUMN._serialized_end = 989

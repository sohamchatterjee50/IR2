...
@hydra.main(version_base=None, config_path="configs", config_name="retrieval_main")
def main(cfg: DictConfig):
    ...
    if args.do_train:
        ...
        retriever_config.to_json_file(os.path.join(args.model_dir, "tapas_config.json"))

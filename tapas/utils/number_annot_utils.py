...
def get_numeric_sort_key_fn(numeric_values):
    ...
    For example, consider the values "05/05/2010" and "August 2007".
    ...
    if value_type == constants.NUM_TYPE:

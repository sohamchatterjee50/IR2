...
from tapas.utils import attention_utils, tableformer_utils
...
def run_custom_attention(
    ...
    attention_mask, custom_attention_layer = None, None
    num_row_heads = int(num_attention_heads * config.restrict_attention_row_heads_ratio)
    ...
    if restrict_attention_mode == _AttentionMode.HEADWISE_SAME_COLUMN_OR_ROW:
        ...
        custom_attention_layer = attention_utils.create_bucketed_attention_layer(
            ...
            token_type_ids=[
                (num_row_heads, True, features["row_ids"]),
        ...
        custom_attention_layer = functools.partial(
            ...
            relative_relation_ids_vocab_size=tableformer_utils.RELATIVE_RELATION_IDS_VOCAB_SIZE,
        )
